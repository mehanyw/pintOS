...
struct lock fs_lock;          /* A global lock which will manage mutual exclusion of filesystem */
...
{                                                    //TODO: Ask Dr. Y or TA why this is causing read-boundary failures
	...
	lock_acquire(&fs_lock);    /* TODO: similarly is a lock needed for a file read ? I will have to rewrite my read and write */
